Ext.define('Console.controller.hotelBranchpicture_betty', {
    extend: 'Ext.app.Controller',
// 所有元件控制的function
    stores: [
        'betty.Service_hotelBranchpicture',
        'betty.Service_hotelHomepagebranch'
    ],
    models: [
        'betty.hotelHomepagebranch',
        'betty.hotelBranchpicture'
    ],
    views: [
        'bettyBranchpicture.ActionPanelDetail',
        'bettyBranchpicture.FormAddDetail',
        'bettyBranchpicture.FormEditDetail',
        'bettyBranchpicture.GridMaster',
        'bettyBranchpicture.GridDetail',
        'bettyBranchpicture.master_plus_detail',
        'bettyBranchpicture.TabPanelDetail'
    ],

    refs: [//Controller會使用到的view
        {
            ref: 'actionPanel',
            selector: 'bbpactionpaneldetail'
        }, {
            ref: 'DetailGrid',
            selector: 'bbpgriddetail'
        }, {
            ref: 'formAdd',
            selector: 'bbpformadddetail'
        }, {
            ref: 'formEdit',
            selector: 'bbpformeditdetail'
        },  {
            ref: 'GridMaster',
            selector: 'bbpgridmaster'
        }
    ],
    ...
    config: {//把會一直重複用到的檔案匯入
        formAddTitle: '新增',
        formEditTitle: '編輯',
        addRequestUrl: './modules/source/controller/betty_branchPicture/add_picture_detail.php',
        editRequestUrl: './modules/source/controller/betty_branchPicture/edit_picture_detail.php'
    },
    ...
    init: function() {
        ...
        me.control({
            ...
            'bbpgriddetail button[action=add_user]': {
                click: me.addData
            },
            'bbpgriddetail button[action=edit_user]': {
                click: me.editData
            },
            'bbpgriddetail button[action=delete_user]': {
                click: me.deleteData
            },
            'bbpformadddetail button[action=form_add_confirm]': {
                click: me.addConfirm
            },
            'bbpformadddetail button[action=form_add_cancel]': {
                click: me.FormCancel
            },
            'bbpformeditdetail button[action=form_edit_confirm]': {
                click: me.editConfirm
            },
            'bbpformeditdetail button[action=form_edit_cancel]': {
                click: me.FormCancel
            }
        });
    },
    ...
    addData: function(btn) {
        ...
        var brand_id = record.data['branch_id'];

        me.showForm(form, title);
        form.getForm().findField('branch_id').setValue(brand_id);
    },
