Ext.define('Console.controller.Hank', {
    ...
    refs: [{
        ref: 'actionPanel',
        selector: 'hkactionpanel'
    }, {
        ref: 'grid',
        selector: 'hkgridmaster'
    }, {
        ref: 'formAdd',
        selector: 'hkformadd'
    }, {
    ...
    init: function() {
        ...
        me.control({
            ...
            'hkgridmaster button[action=add_user]': {
                click: me.addData
            },
            'hkgridmaster button[action=edit_user]': {
                click: me.editData
            },
            'hkgridmaster button[action=delete_user]': {
                click: me.deleteData
            },
            'hkformadd button[action=form_confirm]': {
                click: me.addConfirm
            },
            'hkformadd button[action=form_cancel]': {
                click: me.addCancel
            },
            'hkformedit button[action=form_confirm]': {
                click: me.editConfirm
            },
            'hkformedit button[action=form_cancel]': {
                click: me.editCancel
            },
            'hkgridmaster button[action=display_west]': {
                click: me.displaywest
            }
        });
    },
