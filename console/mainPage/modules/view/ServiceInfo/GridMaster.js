Ext.define('Console.view.ServiceInfo.GridMaster', {
	extend: 'Console.override.Grid',
	alias: 'widget.sigridmaster',
			...
			columns: [
    			{
                    ...
                    flex: 1,
                    renderer: function(value, p, r) {
                       return r.data['service_identity'] == 0 ? '預設'
                ...
                {
                    text: MSG['add'],
                    action: 'add_service_info'
                }, {
                    text: MSG['edit'],
                    action: 'edit_service_info',
                    allowMulti: false,
                    disabled: true
                }, {
                    text: MSG['delete'],
                    action: 'delete_service_info',
                    allowMulti: true,
                    disabled: true
                }, '->', {
