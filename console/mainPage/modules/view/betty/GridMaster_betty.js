Ext.define('Console.view.betty.GridMaster_betty', {
	extend: 'Console.override.Grid',//繼承這個檔案
	alias: 'widget.bettygridmaster',
// 外框
	requires: [
			...
			columns: [
        		 {
                    ...
                    header: MSG['address_t'],//標題列名稱:地址
                    dataIndex: 'address',
                    flex: 3
                },{
                    header: MSG['birthday_t'],//標題列名稱:生日
                    dataIndex: 'birthday',
                    flex: 1
                }
            ],
