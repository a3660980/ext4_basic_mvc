<style type="text/css">
 ...
 /* feeds end */
	...
	.north-panel-logo .x-panel-body {
		background-image: url(<?php echo $sys_image; ?>/title_bg.PNG);
	...
	.row-expander-td-label {
		text-align: right;
		vertical-align:middle;
		padding-right: 5px;
	}

	.row-expander-td-fieldvalue {
		vertical-align:middle;
	}
...
.ext-cal-ic {
    /*background-image: url(../default/images/calendar-sprites.gif);*/
    background-repeat: no-repeat;
    display: none;
    height: 11px;
    line-height: 11px;
...
.extensible-cal-icon-evt-copy {
    background-image:url(../images/default/silk/date_copy.png) !important;
}
...
.amount-showpanel-content p{
    float:left;
    width: 20%;
    padding:8px 5px;
}
.amount-showpanel-content b{
    margin-right: 5%;
}
.amount-showpanel-content span{
    color:limegreen;
    text-align: right;
}
</style>
